    ...
    <div className="p-8 max-w-6xl mx-auto space-y-6">
      ...
      <Card className="flex flex-col sm:flex-row items-center sm:items-start gap-6 p-6 relative">
        ...
        <div className="text-center sm:text-left flex-1 space-y-2">
          ...
          <p className="text-gray-500 text-sm">
            Class: <span className="font-medium">{cls?.name || "N/A"}</span> |
            Gender:{" "}
      ...
      <Tabs defaultValue="personal" className="space-y-4">
        ...
        <TabsContent value="personal">
          <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-600">
              ...
              <p>
                <strong>Aadhar No:</strong> {user.adharNo || "N/A"}
              </p>
              <p>
        ...
        <TabsContent value="academic">
          <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-600">
              <p>
                <strong>Class:</strong> {cls?.name || "N/A"}
              </p>
              <p>
              ...
              <p>
                <strong>UDISE No:</strong> {student.udiseCode}
              </p>
              <p>
                  ...
                  <TableBody>
                    {student.fees.map((fee) => (
                      <TableRow key={fee.id}>
                        ...
                        <TableCell>
                          {fee.status === "PAID" ? (
                            <Badge variant="outline">Paid</Badge> // green
                          ) : fee.status === "PENDING" ? (
                            <Badge variant="destructive">Pending</Badge> // red
                          ) : (
